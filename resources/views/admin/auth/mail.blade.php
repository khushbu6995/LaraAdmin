    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" style="height:100%; width:600px;">
      ...
      <tr>
        <td align="center" bgcolor="#ffffff" style="padding:30px">
          ...
          <p>
            <a target="_blank" href="http://127.0.0.1:8000/reset-Password-link" style="text-decoration:none; background-color: black; border: black 1px solid; color: #fff; padding:10px 10px; display:block;width: 30%;
    margin: auto;">
              <strong>Reset Password</strong></a>
          </p>
          <p style="text-align:left">Reset Your Password and LogIn again To stay with LaraAdmin</p>
          <p style="text-align:left">
            Sincerely,<br>The LaraAdmin Team
          </p>
        </td>
      </tr>
      </tbody>
